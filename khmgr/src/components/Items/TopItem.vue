      ...
      <div class="app-list-operation">
        <div class="operation-desc">
          ...
          <!-- <div class="operation-desc-txt">
            ...
            <div>
              发送人群 :
              <span class="txt">{{ topItem.msgRq }}</span>
            </div>
          </div> -->
        </div>
        <div class="opertion-btn">
          <a-button-group>
            <a-button @click="() => handleEdit(topItem.newsId)">编辑</a-button>
            <a-button type="danger" @click="() => showConfirm(topItem.newsId)">删除</a-button>
          </a-button-group>
        </div>
      </div>
    </div>
